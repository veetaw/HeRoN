...
def plot_training(rewards, agent_wins, enemy_wins, moves, success_rate, match_score):
    ...
    plt.savefig("Cumulative_Win_dqn_Yi_flan_random_1000.png")
    ...
    plt.xlabel('Episodes')
    plt.ylabel('Moves')
    plt.savefig("Moves_dqn_Yi_flan_random_1000.png")
    ...
    plt.legend()
    plt.savefig("Success_rate_dqn_Yi_flan_random_1000.png")
    ...
    plt.savefig("Score_dqn_Yi_flan_random_1000.png")
